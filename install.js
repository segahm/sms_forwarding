var XpiInstaller = {
	...
	extFullName: 'iPalem', // The name displayed to the user (don't include the version)
	extShortName: 'ismsend', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Sergey Mirkin',
